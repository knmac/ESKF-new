...
function [firstColOfPair, secondColOfPair,currFeat, status] = MatchFeat(prevFeat, currFeat)
...
% tform.T, VisualizeFeatures(prevFeat, prevInliers, currFeat, currInliers);
